...
**If the driver is already installed on the computer, you do not need to install another one. If not, please follow the steps below.**

Click ![set](../img/set.png) to choose “**Install driver**”.
...
![Equip-17](../img/Equip-17-17575728680301.png)
