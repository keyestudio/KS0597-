...
Set the receiving frequency: Similarly, turn the potentiometer clockwise to the end, and then slowly turn it counter-clockwise just till the SLED is going to be on (it is still <span style="color: rgb(10, 10, 200);">off</span> finally). 

![6003](../../img/6003.gif)

After that, we can put it into use. When we throw the basketball, the SLED lights up on the moment the ball drops into the basket.
...
graph TD
    ...
    F -- YES --> G[Counter goal+1<br>Delay 50ms]
...
After uploading the code, place the ball collection box under the basketball stand to ensure that the ball does not roll anywhere else.

![6013](../../img/6013.png)

Throw the basketball into the basket. When the goal is scored:
