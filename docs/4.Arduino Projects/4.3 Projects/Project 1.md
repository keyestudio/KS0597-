...
- `sensorValue` is the quantization of the ADC on the analog signal of the module. The value is directly proportional to the light intensity (the brighter the light is, the greater the value will be).
